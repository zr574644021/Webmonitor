...
func main() {
	remsg, n, _ := Send("114.114.114.114:53", "www.ccsu.cn")
	ip := strconv.Itoa(int(remsg[n-4]))+"."+strconv.Itoa(int(remsg[n-3]))+"."+strconv.Itoa(int(remsg[n-2]))+"."+strconv.Itoa(int(remsg[n-1]))
	fmt.Println(ip)
}